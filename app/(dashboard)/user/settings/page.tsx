...
const PlatformSettings = () => {
  ...
  const [profile, setProfile] = useState({
    ...
    tiktok: "tiktok.com/@nguyenvanan",
    youtube: "youtube.com/nguyenvanan",
    instagram: "instagram.com/nguyenvanan",
  });
  ...
  const handleSelectAvatar = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file.type.startsWith("image/")) {
      alert("Chỉ được upload hình ảnh");
      return;
    }
              ...
              <Card className="md:col-span-4 lg:col-span-3 h-fit">
                ...
                <CardContent className="flex flex-col items-center gap-4">
                  ...
                  <div className="flex flex-col w-full gap-2">
                    ...
                    <Button
                      variant="ghost"
                      disabled={!avatarPreview && !profile.avatarUrl}
              ...
              <div className="md:col-span-8 lg:col-span-9 space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      <LucideFacebook className="w-5 h-5 text-blue-600" />
                      <Input
                    ...
                    <div className="flex items-center gap-4">
                      <TikTokIcon className="w-5 h-5 text-[#000000]" />
                      <Input
                ...
                <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li className="flex items-center gap-2">
                      <Check size={14} className="text-green-500" /> Ít nhất 8
                      ký tự
                    </li>
                    <li className="flex items-center gap-2">
                      <Check size={14} className="text-green-500" /> Có chữ hoa
                      và chữ thường
                    </li>
                    <li className="flex items-center gap-2">
                      <Check size={14} className="text-green-500" /> Có ít nhất
                      1 số
                    </li>
                  </ul>
                </div>
            ...
            <Card className="border-destructive/30">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">
                  Khi bạn xóa tài khoản, tất cả dữ liệu sẽ bị xóa vĩnh viễn và
                  không thể khôi phục.
                </p>
                    ...
                    {[
                      {
                        key: "emailNews",
                        label: "Tin tức mới",
                        desc: "Nhận thông báo về các bài viết mới",
                      },
                      {
                        key: "emailJobs",
                        label: "Việc làm phù hợp",
                        desc: "Công việc phù hợp với hồ sơ của bạn",
                      },
                      {
                        key: "weeklyDigest",
                        label: "Tổng hợp hàng tuần",
                        desc: "Bản tin tổng hợp các hoạt động",
                      },
                    ].map((item) => (
                      <div
                        key={item.key}
                    ...
                    {[
                      {
                        key: "pushMessages",
                        label: "Tin nhắn mới",
                        desc: "Thông báo tin nhắn real-time",
                      },
                      {
                        key: "jobAlerts",
                        label: "Cảnh báo việc làm",
                        desc: "Công việc mới theo tiêu chí",
                      },
                    ].map((item) => (
                      <div
                        key={item.key}
          ...
          <TabsContent value="privacy" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Kiểm soát ai có thể nhìn thấy thông tin của bạn.
                </CardDescription>
              </CardHeader>
                ...
                >
                  {[
                    ...
                    },
                    {
                      value: "connections",
                      label: "Chỉ kết nối",
                      desc: "Chỉ những người trong mạng lưới",
                    },
                    {
                      value: "private",
                      label: "Riêng tư",
                    ...
                    <div
                      key={option.value}
                      className="flex items-start space-x-3 space-y-0 rounded-md border p-4 hover:bg-muted/30 bg-primary/5 transition-colors"
                    >
                      <RadioGroupItem
                        value={option.value}
                        id={option.value}
                        className="mt-1 bg-primary/20 data-[state=checked]:border-primary h-4 w-4 rounded-full border border-muted focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                      />
                ...
                {[
                  {
                    ...
                    desc: "Cho phép người khác xem email",
                  },
                  {
                    key: "showPhone",
                    label: "Hiển thị số điện thoại",
                    desc: "Cho phép người khác xem SĐT",
                  },
                  {
                    key: "allowMessages",
                    label: "Cho phép nhắn tin",
                    desc: "Người lạ có thể gửi tin nhắn",
                  },
                ].map((item) => (
                  <div
                    key={item.key}
                  ...
                  >
                    ...
                    <Switch
                      ...
                      className="bg-primary/30 data-[state=checked]:bg-primary"
                    />
                  </div>
                ))}
              </CardContent>
