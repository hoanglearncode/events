...
const NewsAdminDashboard = () => {
  ...
  const topPosts = [
    {
      title: "Công nghệ AI đột phá trong năm 2025",
      views: 125000,
      engagement: 95,
      category: "Công nghệ",
    },
    ...
    {
      title: "Giải vô địch bóng đá: Kết quả bất ngờ",
      views: 87000,
      engagement: 92,
      category: "Thể thao",
    },
    {
      title: "Phim mới phá kỷ lục doanh thu",
      views: 76000,
      engagement: 84,
      category: "Giải trí",
    },
    {
      title: "Chính sách mới về môi trường",
      views: 65000,
      engagement: 78,
      category: "Chính trị",
    },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, index) => {
          ...
          return (
            <div
              key={index}
              className="card-elevated rounded-lg p-6 hover:shadow-xl transition-shadow"
            >
