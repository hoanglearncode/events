...
const categoryData = [
  { category: "Cà phê hạt", percentage: 45, revenue: 342000000, color: "bg-brand-primary" },
  { category: "Cà phê pha sẵn", percentage: 28, revenue: 213000000, color: "bg-brand-secondary" },
  { category: "Cà phê hòa tan", percentage: 18, revenue: 137000000, color: "bg-brand-accent" },
  { category: "Phụ kiện", percentage: 9, revenue: 68500000, color: "bg-brand-warning" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="border-border shadow-md glass-dark overflow-hidden relative">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-xs text-muted-foreground mt-2">So với tháng trước</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border shadow-md glass-dark overflow-hidden relative">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-xs text-muted-foreground mt-2">Trong năm nay</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border shadow-md glass-dark overflow-hidden relative">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-xs text-muted-foreground mt-2">Khách hàng mới: 342</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-border shadow-md glass-dark overflow-hidden relative">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-sm text-muted-foreground mb-1">Giá trị đơn TB</p>
              <p className="text-3xl font-bold text-foreground">₫197K</p>
              <p className="text-xs text-muted-foreground mt-2">Đơn hàng trung bình</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                  ...
                  <div className="space-y-4">
                            ...
                            <div className="relative w-full group">
                              ...
                              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10">
                                <div className="bg-foreground text-background text-xs rounded-lg px-3 py-2 whitespace-nowrap shadow-lg">
                                  <p className="font-semibold">₫{(data.revenue / 1000000).toFixed(1)}M</p>
                                  <p className="text-xs opacity-80">{data.orders} đơn</p>
                    ...
                    <div className="flex items-center justify-center gap-6 pt-4 border-t border-border">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-muted-foreground">Tăng trưởng dương</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <div className="mt-6 pt-6 border-t border-border">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-lg font-bold text-brand-primary">
                        ₫{(categoryData.reduce((sum, cat) => sum + cat.revenue, 0) / 1000000).toFixed(1)}M
                      </span>
                    </div>
                  </div>
                </CardContent>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-2xl font-bold text-brand-success">+24.5%</p>
                      <p className="text-xs text-muted-foreground mt-1">So với cùng kỳ</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Từ đặt đến giao</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="customers" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card className="border-border shadow-xl glass-dark">
                <CardHeader className="border-b border-border">
                  <CardTitle className="text-foreground">Phân khúc khách hàng</CardTitle>
                  <p className="text-sm text-muted-foreground mt-1">
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    {[
                      { label: "VIP (>20 đơn)", count: 142, percentage: 5, color: "bg-brand-primary" },
                      { label: "Thân thiết (10-20 đơn)", count: 387, percentage: 14, color: "bg-brand-secondary" },
                      { label: "Trung thành (5-9 đơn)", count: 856, percentage: 30, color: "bg-brand-accent" },
                      { label: "Thông thường (<5 đơn)", count: 1462, percentage: 51, color: "bg-muted-foreground" },
                    ].map((segment, index) => (
                      <div key={index} className="space-y-2">
                        <div className="flex items-center justify-between">
              ...
              <Card className="border-border shadow-xl glass-dark">
                <CardHeader className="border-b border-border">
                  <CardTitle className="text-foreground">Độ hài lòng khách hàng</CardTitle>
                  <p className="text-sm text-muted-foreground mt-1">
                    Đánh giá trung bình
                  </p>
                </CardHeader>
                  ...
                  <div className="text-center mb-6">
                    <div className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br from-brand-primary/10 to-brand-secondary/10 mb-4">
                      <div className="text-center">
                        <p className="text-4xl font-bold text-brand-primary">4.8</p>
