  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      description:
        "Vị trí 'Senior Product Designer' tại VinGroup phù hợp với hồ sơ của bạn.",
      time: "2 phút trước",
      isRead: false,
    },
    {
      ...
      description:
        "Bạn nhận được một lời mời phỏng vấn trực tuyến từ bộ phận HR của tập đoàn Viettel.",
      time: "1 giờ trước",
      isRead: false,
    },
    {
      ...
      description:
        "Hệ thống sẽ bảo trì định kỳ vào 2:00 AM ngày mai để nâng cấp trải nghiệm người dùng.",
      time: "5 giờ trước",
      isRead: true,
    },
  ]);
      ...
      <div className="mx-5 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-border pb-6">
          <div>
            ...
            <p className="text-muted-foreground">
              Cập nhật những tin tức và cơ hội mới nhất dành cho bạn.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="text-brand-primary hover:bg-muted"
            >
        ...
        <Tabs defaultValue="all" className="w-full">
          <TabsList className="bg-muted/50 p-1 mb-6 border border-border inline-flex w-full sm:w-auto">
            <TabsTrigger
              value="all"
              className="px-6 data-[state=active]:bg-card data-[state=active]:text-brand-primary data-[state=active]:shadow-sm"
            >
              Tất cả
            </TabsTrigger>
            <TabsTrigger
              value="jobs"
              className="px-6 data-[state=active]:bg-card data-[state=active]:text-brand-primary"
            >
              Tuyển dụng
            </TabsTrigger>
            <TabsTrigger
                  ...
                  <CardContent className="p-5 flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="flex items-center justify-between">
                        <h4
                          className={`text-sm font-bold uppercase tracking-wide ${!n.isRead ? "text-brand-secondary" : "text-muted-foreground"}`}
                        >
                          {n.type === "job"
                            ? "Tuyển dụng"
                            : n.type === "message"
        ...
        <div className="bg-muted/30 p-4 rounded-2xl border border-dashed border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Button
            variant="outline"
            className="border-brand-accent text-brand-primary  h-9"
          >
            Cài đặt Email
          </Button>
        </div>
